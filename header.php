...
<head>
    ...
    <meta itemprop="name" content="琳's 博客">
    <meta itemprop="description" content="这里记载着一些奇怪的文章">
    <meta itemprop="image" content="<?php $this->options->themeUrl('img/log.jpg'); ?>">
...
/* 使用外部源样式（JS,CSS,MAP）
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('css/new.css'); ?>">
...
?>
    ...
    <script src="<?php $this->options->themeUrl('js/jquery.pjax.js'); ?>" type="text/javascript"></script>
    <script src="<?php $this->options->themeUrl('main.js'); ?>" type="text/javascript"></script>
    <?php $this->header();
?>
    <?php $this->header();
...
?>
                                <div class="newComment-data">
                                    <h3><?php $comments->author(false);
?></h3>
                                    <p><?php $comments->excerpt(24, '...');
?></p>
                                </div>
...
if ($recent->have()):
                        ...
                        <a href="<?php $recent->permalink(); ?>">
                            <div class="newPage-item">
                                ...
                                <?php else: ?>
                                    <?php if ($this->options->slimg && 'showoff'==$this->options->slimg): ?><a href="<?php $this->permalink() ?>" ><?php showThumbnail($this);
?></a>
                                    <?php else: ?>
...
?>
                    ...
                    <ul class="tags-list">
                        <?php while ($tags->next()): ?>
                            <li class="mdui-ripple"><a href="<?php $tags->permalink(); ?>" rel="tag" class="size-<?php $tags->split(5, 10, 20, 30); ?>" title="<?php $tags->count(); ?> 个话题"><?php $tags->name();
?></a></li>
                        <?php endwhile;
?>
                        <?php else: ?>
